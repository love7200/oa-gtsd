...
class ContactHomeViewController: UITableViewController {
    ...
    var myDepartmentURL:String? {
        ...
        let url = AppDelegate.o2Collect.generateURLWithAppContextKey(ContactContext.contactsContextKeyV2, query: ContactContext.personInfoByNameQuery, parameter: ["##name##":(acc.unique ?? "默认值")! as AnyObject])
        return url
    }
